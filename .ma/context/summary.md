...
Generated: 2025-10-18T21:00:58.344Z
...
- Lines: 25076
- Largest (top 10):
  - .ma/planning/task-004c60d8-68a8-4060-ab5c-e8a364fb085c-plan.log (520551 bytes)
  ...
  - .ma/context/files.ndjson (8445 bytes)
...
- Longest (top 10):
  - .ma/planning/task-004c60d8-68a8-4060-ab5c-e8a364fb085c-plan.log (14758 lines)
  ...
  - .ma/context/files.ndjson (59 lines)
...
- **files.ndjson** (8445 bytes, 59 lines)
- **snapshot.json** (23844 bytes, 823 lines)
- **summary.md** (17 bytes, 1 lines)

### .ma/planning

- **task-004c60d8-68a8-4060-ab5c-e8a364fb085c-plan.log** (520551 bytes, 14758 lines)
...
- **fileIngest.ts** (62 bytes, 2 lines)
- **logEntry.test.ts** (241 bytes, 7 lines)
- **logEntry.ts** (83 bytes, 5 lines)
- **logSummarizer.test.ts** (187 bytes, 6 lines)
