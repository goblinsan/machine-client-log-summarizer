...
Generated: 2025-10-18T17:54:24.071Z
...
- Lines: 23701
- Largest (top 10):
  - .ma/planning/task-004c60d8-68a8-4060-ab5c-e8a364fb085c-plan.log (480600 bytes)
  - .ma/qa/task-004c60d8-68a8-4060-ab5c-e8a364fb085c-qa.log (128658 bytes)
  - package-lock.json (125965 bytes)
  - .ma/context/snapshot.json (24802 bytes)
  - .ma/context/files.ndjson (8295 bytes)
  - .ma/context/summary.md (4632 bytes)
...
- Longest (top 10):
  - .ma/planning/task-004c60d8-68a8-4060-ab5c-e8a364fb085c-plan.log (13638 lines)
  - .ma/qa/task-004c60d8-68a8-4060-ab5c-e8a364fb085c-qa.log (3924 lines)
  - package-lock.json (3711 lines)
  - .ma/context/snapshot.json (851 lines)
  - src/styles/_migrated.scss (198 lines)
  - src/styles/_components.scss (182 lines)
  - .ma/context/summary.md (121 lines)
...
- **files.ndjson** (8295 bytes, 58 lines)
- **snapshot.json** (24802 bytes, 851 lines)
- **summary.md** (4632 bytes, 121 lines)

### .ma/planning

- **task-004c60d8-68a8-4060-ab5c-e8a364fb085c-plan.log** (480600 bytes, 13638 lines)

### .ma/qa

- **task-004c60d8-68a8-4060-ab5c-e8a364fb085c-qa.log** (128658 bytes, 3924 lines)
...
- **fileIngest.ts** (346 bytes, 10 lines)
- **logEntry.test.ts** (241 bytes, 7 lines)
- **logEntry.ts** (67 bytes, 4 lines)
